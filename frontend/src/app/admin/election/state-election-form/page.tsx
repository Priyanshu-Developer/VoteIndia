  ...
  return (
    <Box component='div'  bgcolor="var(--mui-palette-background-default)"    color="primary" p={6} sx={{ widht: "100vw" }} overflow={'auto'}>
            ...
            <Box display="flex" flexDirection="column" alignItems="center" gap={2} mb={4} >
              ...
              <Typography variant="h5" fontWeight={600}> State Election Form  </Typography>
              <Typography variant="subtitle1"> Fill the form to create a new state election. </Typography>
            </Box>
            ...
            {/* State Selector */}
            <SelectComponent menuitems={states} label="State" width={400} value={state} setValue={setState} />
...
export default StateElectionForm;
